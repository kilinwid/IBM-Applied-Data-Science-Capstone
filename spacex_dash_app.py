...
def scatter(entered_site,payload):
    ...
    if entered_site=='ALL':
        ...
        fig=px.scatter(filtered_df[filtered_df['Launch Site']==entered_site],x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f"Payload vs Success for site {entered_site}")
        return fig
